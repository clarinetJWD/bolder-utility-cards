      ...
      <div class="card-config">
        ...
        <div id="editor">
          ${c<h?N`
                ...
                ${so(this._getKey(null!==(l=this.config.cards)&&void 0!==l?l:[],c),N`<hui-card-element-editor
                    .hass=${this.hass}
